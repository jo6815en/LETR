...
PYTHONPATH=$PYTHONPATH:./src python src/main.py --coco_path data/york_processed \
    --output_dir $output  --LETRpost  --backbone resnet50  --layer1_frozen  --resume exp/res50_stage2_focal/checkpoints/checkpoint0024.pth  \
